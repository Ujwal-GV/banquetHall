...
<form action="cascade.php" method="POST">
    <body>
        <div class="box">
            <h2>FILL UP</h2>
            ...
            <label>3). Price :</label><label class="lab">12,000/-</label><br><br>
            <div class="box1">
...
if($_POST['submit'])
{
    $user=$_POST['user'];
    $d_id=$_POST['d_id'];
    $sql="UPDATE bookings SET d_id=102 WHERE user='{$_SESSION['user']}'";
    $sql1="UPDATE registration SET price=12000 WHERE user='{$_SESSION['user']}'";
