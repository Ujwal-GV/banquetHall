...
.box{
    background: linear-gradient(to top left,rgb(133, 197, 223),rgb(171, 171, 226),rgb(46, 43, 43));
    border-radius: 5px;
    height: 550px;
    width: 70%;
...
@media (max-width: 420px)
{
    ...
    <body>
        ...
        <div class="box">
            ...
            <label>2). Username :</label><input type="text" name="user" value="<?php echo $final['user']; ?>" title="Enter your username" required="" placeholder="Enter the username" readonly="true"><br><br>
            <label>3). Password :</label><input type="password" name="password" value="<?php echo $final['password']; ?>" title="Enter your password" required="" placeholder="Enter your password" readonly="true"><br><br>
        ...
        <div class="sub">
            ...
            <button class="back"><a href="display.php">BACK</a></button>
        </div>
        </div>
        </form>
    </body>
