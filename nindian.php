...
<form action="nindian.php" method="POST">
    <body>
        <div class="box">
            <h2>FILL UP</h2>
            ...
            <script>
                ...
                var theProduct = parseInt(numOne) * 400;
                document.getElementById("myText").innerHTML = theProduct;
                }
            </script>
            <label>3). Per plate :</label><label class="lab"><b>400/-</b></label><br><br><br><hr width="80%" color="black"><br>
...
if($_POST['submit'])
{
    ...
    $sql="UPDATE bookings SET c_id=1002 WHERE user='{$_SESSION['user']}'";
