    ...
    <body>
        <div class="box">
            ...
            <script>
                ...
                var theProduct = parseInt(numOne) * 355;
                document.getElementById("myText").innerHTML = theProduct;
                }
            </script>
            <label>3). Per plate :</label><label class="lab"><b>355/-</b></label><br><br><br><hr width="80%" color="black"><br>
...
if($_POST['submit'])
{
    ...
    $sql="UPDATE bookings SET c_id=1001 WHERE user='{$_SESSION['user']}'";
