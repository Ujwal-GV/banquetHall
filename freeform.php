...
<form action="freeform.php" method="POST">
    <body>
        <div class="box">
            <h2>FILL UP</h2>
            ...
            <label>2). Booking date:</label><input type="date" name="date" required="" id="boo" value="<?php echo $final['date']; ?>"><br><br>
            <label>3). Price :</label><label class="lab">20,000/-</label><br><br>
            <div class="box1">
...
if($_POST['submit'])
{
    $user=$_POST['user'];
    $d_id=$_POST['d_id'];
    $sql="UPDATE bookings SET d_id=103 WHERE user='{$_SESSION['user']}'";
    $sql1="UPDATE registration SET price=20000 WHERE user='{$_SESSION['user']}'";
